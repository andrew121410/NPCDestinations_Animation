...
public class VersionBridge_1_8_R3 implements VersionBridge {
    //Bed Variables
    ...
    public void changeChestState(Location blockLocation, Boolean open) {
        ...
        for (Player player : Bukkit.getOnlinePlayers()) {
            ...
            PacketPlayOutBlockAction blockActionPacket = new PacketPlayOutBlockAction(position, net.minecraft.server.v1_8_R3.Block.getById(blockLocation.getBlock().getTypeId()), (byte) 1, dataByte);
