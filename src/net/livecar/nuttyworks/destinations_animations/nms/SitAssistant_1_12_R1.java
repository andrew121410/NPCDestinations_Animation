...
public class SitAssistant_1_12_R1 implements SitAssistant {
    ...
    public void unSitNPC(Sitting_NPC setting) {
        ...
        setting.npc.teleport(setting.npc.getEntity().getLocation().clone().add(0, 0.5, 0), TeleportCause.PLUGIN);
